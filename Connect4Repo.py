...
# CONNECT FOUR
# Host a game with another person using command: playGame('human', 'human')
...
class Board:
    ...
    def hostGame(self):
        """hosts a connect 4 game with an ai
        """
        ...
        while True:
            ...
            if self.isFull() == True:
                ...
                print ("Full board, tie game!")
                break
        if userxo == 'x' and self.winsFor('X') == True:
            print(self)
            print('You win! Congrats!')
        if userxo == 'o' and self.winsFor('O') == True:
            print(self)
            print('You win! Congrats!')
        if userxo == 'x' and self.winsFor('O') == True:
            print(self)
            print('I win! But more importantly, you lose! HAHAHA')
        if userxo == 'o' and self.winsFor('X') == True:
            print(self)
            print('I win! But more importantly, you lose! HAHAHA')
            ...
            if po == 'human':
                ...
                while True:
                    ...
                    while not self.allowsMove(users_col):
                        ...
                        users_col = int(input("Choose a column: "))
                        self.addMove(users_col,'X')
                        c = random.choice(range(self.width))
